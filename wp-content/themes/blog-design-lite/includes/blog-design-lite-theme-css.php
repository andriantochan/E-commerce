 ...
 * @since 1.0
 */
function blog_design_lite_theme_dynemic_css() {	

	// Menu bar Bg Color
	$menu_bar_bg_clr = blog_design_lite_get_theme_mod( 'menu_bar_bg_clr' );
	 
	// Action to add theme dynemic CSS	// Menu bar Link Color
	$menu_bar_link_clr = blog_design_lite_get_theme_mod( 'menu_bar_link_clr' );
	
	// Menu bar Link Hover Color
	$menu_bar_linkh_clr = blog_design_lite_get_theme_mod( 'menu_bar_linkh_clr' );
	 
	// Heading Color
	$h1_clr = blog_design_lite_get_theme_mod( 'h1_clr' );
	$h2_clr = blog_design_lite_get_theme_mod( 'h2_clr' );
	$h3_clr = blog_design_lite_get_theme_mod( 'h3_clr' );
	$h4_clr = blog_design_lite_get_theme_mod( 'h4_clr' );
	$h5_clr = blog_design_lite_get_theme_mod( 'h5_clr' );
	$h6_clr = blog_design_lite_get_theme_mod( 'h6_clr' );	
	
	// Link Color
	$link_clr = blog_design_lite_get_theme_mod( 'link_clr' );
	 
	// Link Hover Color
	$hover_link_clr = blog_design_lite_get_theme_mod( 'hover_link_clr' );	

	//read more button
	$continue_read_clr 	= blog_design_lite_get_theme_mod( 'continue_read_clr' );
	$continue_read_hvr_clr 	= blog_design_lite_get_theme_mod( 'continue_read_hvr_clr' );
...
.main-navigation .current-menu-item a, .header-content .blog-design-lite-sn a:hover, .header-content .blog-design-lite-sn a:focus, .header-content .blog-design-lite-sn a:active{color:<?php echo esc_attr($menu_bar_linkh_clr); ?>;} 
...
add_action( 'wp_head', 'blog_design_lite_theme_dynemic_css' );