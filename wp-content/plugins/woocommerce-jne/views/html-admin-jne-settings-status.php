...
<table class="woocommerce_jne_status_table widefat is-large-screen" id="wc_jne_status" cellspacing="0">
	<thead>
    	<tr>
        	<th colspan="3"><?php echo __( 'AgenWebsite Product Status', 'woocommerce-jne' );?></th>
        </tr>
    </thead>
    <tbody>
        <tr>
...
<table class="woocommerce_jne_status_table widefat is-large-screen" cellspacing="0">
	<thead>
    	<tr>
        	<th colspan="3"><?php echo __( 'WooCommerce JNE Settings Status', 'woocommerce-jne' ); printf( '<a href="%s" target="new">%s</a>', $dok_table, WC_JNE()->help_tip( 'Klik untuk melihat penjelasan tentang table ini' ) )?></th>
        </tr>
    </thead>
    <tbody>
        <tr>
        	<td><?php echo __( 'Plugin JNE Version', 'woocommerce-jne' );?></td>
        ...
        <tr>
        	<td>
				<?php echo __( 'WC Weight Unit', 'woocommerce-jne' );?>
        ...
        <tr>
        	<td>
				<?php echo __( 'WC Currency Symbol', 'woocommerce-jne' );?>
        ...
        <tr>
        	<td>
				<?php echo __( 'WC Currency Decimals', 'woocommerce-jne' );?>
